...
class Window(pyglet.window.Window):
    ...
    def update_caption(self, mouse):
        """ 添加坐标显示 """
        caption = "{}  鼠标位置: {},{}".format(self._title, mouse.x,mouse.y)
...
icon1 = pyglet.image.load(rss.get('https://rss.leaplearner.com/ud/production//69892/159912453130908.PNG'))
icon2 = pyglet.image.load(rss.get('https://rss.leaplearner.com/ud/production//69892/159912453130908.PNG'))
